...
(function ($) {
	...
	--------------------- */
    const product_men = $('product-slider.men'); //class: product-slider index.balde.php
    const product_women = $("product-slider.men");

    $('.filter-control').on('click', '.item', function () {
        const $item = $(this);
        //xóa class active item cùng cấp
        $item.siblings().removeClass('active');
        //thêm class active vào item để click
