                ...
                <div class="ht-right">
                    ...
                    <div class="lan-selector">
                        <select name="countries" id="countries" class="language_drop" style="width:300px;">
                            <option value="yt" data-image="front/front/img/flag-1.jpg" data-imagecss="flag-yt" data-title="English">English</option>
                            <option value="yu" data-image="front/img/flag-2.jpg" data-imagecss="flag-yu" data-title="Việt Nam">Việt Nam</option>
                        </select>
                    </div>
                ...
                <div class="col-lg-3">
                    <div class="footer-left">
                        <div class="footer-logo">
                            <a href="index.html">
                                <img src="front/img/foorer-logo.png" height="25" alt="">
                            </a>
                        </div>
                        <ul>
