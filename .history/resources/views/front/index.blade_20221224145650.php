...
<head>
    ...
    <!-- Css Styles -->
    <link rel="stylesheet" href="front/front/css/bootstrap.min.css" type="text/css">
    <link rel="stylesheet" href="front/front/css/font-awesome.min.css" type="text/css">
    <link rel="stylesheet" href="front/front/css/themify-icons.css" type="text/css">
    <link rel="stylesheet" href="front/front/css/elegant-icons.css" type="text/css">
    <link rel="stylesheet" href="front/front/css/owl.carousel.min.css" type="text/css">
    <link rel="stylesheet" href="front/front/css/nice-select.css" type="text/css">
    <link rel="stylesheet" href="front/front/css/jquery-ui.min.css" type="text/css">
    <link rel="stylesheet" href="front/front/css/slicknav.min.css" type="text/css">
    <link rel="stylesheet" href="front/front/css/style.css" type="text/css">
</head>
                ...
                <div class="ht-right">
                    ...
                    <div class="lan-selector">
                        <select name="countries" id="countries" class="language_drop" style="width:300px;">
                            ...
                            <option value="yu" data-image="img/flag-2.jpg" data-imagecss="flag-yu" data-title="Việt Nam">Việt Nam</option>
                        </select>
                    </div>
            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="footer-left">
                        <div class="footer-logo">
                            <a href="index.html">
                                <img src="img/foorer-logo.png" height="25" alt="">
                            </a>
                        </div>
                        <ul>
                            <li>50 Thuận An, Bình Dương</li>
                            <li>Phone: +84 98.123.123</li>
                ...
                <div class="col-lg-4">
                    <div class="newslatter-item">
                        <h5>Join Our New Now</h5>
                        <p>Để lại email để nhạn thông báo</p>
