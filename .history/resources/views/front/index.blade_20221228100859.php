            ...
            <div class="row">
                ...
                <div class="col-lg-8 offset-lg-1">
                    <div class="filter-control">
                        <ul>
                            <li class="item active">Tất cả</li>
                            <li class="item">Clothings</li>
                            <li class="item">Shoes</li>
                            <li class="item">Shoes</li>
                            <li class="item">Bags</li>
                        </ul>
                    </div>
                ...
                <div class="col-lg-8">
                    <div class="filter-control">
                        <ul>
                            ...
                            <li class="item" data-tag="*" data-category="men">Clothings</li>
                            <li class="item" data-tag="*" data-category="men">Shoes</li>
                            <li class="item" data-tag="*" data-category="men">Shoes</li>
                            <li class="item" data-tag="*" data-category="men">Bags</li>
                        </ul>
                    </div>
                    <div class="product-slider owl-carousel">
